...
$("#<?php echo Categorydemo::ADMIN_TREE_CONTAINER_ID;?>")
		.jstree({ 
	            ...
	            "ajax" : {
                                 "type":"POST",
 	                          "url" : "<?php echo $baseUrl;?>/altadmin/categorydemo/fetchTree",
	                         "data" : function (n) {
	                          return { 
...
"update" : {
	              ...
	              "action"	: function (obj) {
                     ...
                     $.ajax({
                                 type: "POST",
                                 url: "<?php echo $baseUrl;?>/altadmin/categorydemo/returnForm",
                                data:{
                                          'update_id':  id,
                                           "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                              },
	...
	"action" : function (obj) {
                             ...
                             $.ajax({
                                   type:"POST",
			           url:"<?php echo $baseUrl;?>/altadmin/categorydemo/returnView",
		                   data:   {
                                             "id" :id,
                                            "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                              },
...
//	}//list products
		...
		$.ajax({
                           type:"POST",
			   url:"<?php echo $baseUrl;?>/altadmin/categorydemo/rename",
			   data:  {
		...
		$.ajax({
                           type:"POST",
			    url:"<?php echo $baseUrl;?>/altadmin/categorydemo/remove",
			    data:{
				        "id" : data.rslt.obj.attr("id").replace("node_",""),
			                "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                        },
...
//                      console.log(replaced_node,'REPLACED NODE');
			...
			$.ajax({
				async : false,
				type: 'POST',
				url: "<?php echo $baseUrl;?>/altadmin/categorydemo/moveCopy",
